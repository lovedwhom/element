<template>
    <div>
        ...
        <div class="mt-20">
            <h3>复合型输入框</h3>
            <el-input v-model="input3" placeholder="placeholder">
                <template slot="prepend">prepend</template>
            </el-input>
            <el-input v-model="input3" placeholder="placeholder">
                <template slot="append">prepend</template>
            </el-input>
        </div>
        <div class="mt-20">
            <h3>输入建议</h3>
            ...
            <el-autocomplete
                ...
                <template slot-scope="{ item }">
                    <div class="name" v-if="item">{{ item.value }}</div>
                    <span class="addr" v-if="item">{{ item.address }}</span>
                </template>
            </el-autocomplete>
        </div>
    </div>
